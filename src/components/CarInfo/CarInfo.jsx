      ...
      <div>
        <div className={style.imgWrapper}>
          ...
          <button onClick={handleToggleFavorite} className={style.heartBtn}>
            <svg className={style.heartIcon}>
              <use
                href={`/sprite.svg#${
                  isFavorite ? 'icon-blue-heart' : 'icon-heart'
                }`}
              />
            </svg>
          </button>
        ...
        <div className={style.infoContainer}>
          <div className={style.textContainer}>
            ...
            <p className={style.modelText}>
              {carModel} <span className={style.span}>,</span>
            </p>
            <p>{productionYear}</p>
          </div>
          ...
          <div className={style.detailsRow}>
            ...
            <div>
              <span className={style.carType}> {carType} </span>
              <span className={style.separator}> | </span>
              <span className={style.mileage}>
                {formatMileage(carMileage)} km
              </span>
            </div>
          </div>
        </div>
      </div>
      <NavLink to={`/cars/${carId}`} className={style.btn}>
        Read more
      </NavLink>
    </div>
  );
