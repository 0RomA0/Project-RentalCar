...
import { selectFilters, selectBrands, selectBrandsLoading } from "../../redux/filters/selectors";
  ...
  return (
    <div className={style.filterContainer}>
      {/* Brand */}
        ...
        <div className={style.selectHeader} onClick={() => setBrandOpen(!brandOpen)}>
          {filters.brand || (isLoading ? "Loading..." : "Choose a brand")}
            <svg className={style.icon}>
                      <use href={ `/public/sprite.svg#${brandOpen ? "icon-arrow-up" : "icon-arrow-down"}` } />
            </svg>
        </div>
        {brandOpen && (
        ...
        <div className={style.selectHeader} onClick={() => setPriceOpen(!priceOpen)}>
          {filters.rentalPrice ? `${filters.rentalPrice} $/h` : "Choose a price"}
            <svg className={style.icon}>
                      <use href={ `/public/sprite.svg#${priceOpen ? "icon-arrow-up" : "icon-arrow-down"}` } />
            </svg>
        </div>
        {priceOpen && (
          <ul className={style.selectList}>
