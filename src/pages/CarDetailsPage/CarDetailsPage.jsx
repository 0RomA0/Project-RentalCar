            ...
            <div className={style.containerImgForm}>
                <img className={style.img} src={car.img} alt={car.brand} />
                    ...
                    <div className={style.formWrapper}>
                        ...
                        <p className={style.formSubtitle}> Stay connected! We are always ready to help you. </p>
                        <CarBookingForm />
                    </div>
            </div>
                ...
                <div className={style.textContainer}>
                    <div className={style.descrCarContainer}>
                        <h2 className={style.brandText} > {car.brand} {car.model},  </h2>
                        <p>{car.year}</p>
                    ...
                    <div className={style.addressInfo}>
                        ...
                        <p className={style.mileage}> Mileage: {car.mileage.toLocaleString("en-US").replaceAll(",", " ")} km </p>
                    </div>
                    <p className={style.price}> ${car.rentalPrice} </p>
                                    ...
                                    <ul>
                                        {car.rentalConditions.map((cond, idx) => (
                                            <li className={style.itemCond} key={idx}>
                                                <svg className={style.icon}>
                                                    <use href="/public/sprite.svg#icon-check-circle" />
                                                </svg>
                                                <p> {cond} </p>
                                            </li>
                                        ))}
                        ...
                        <div className={style.specific}>
                            ...
                            <p>
                                <svg className={style.icon}>
                                    <use href="/public/sprite.svg#icon-calendar" />
                                </svg>
                                Year: {car.year}
                            </p>
                            <p>
                                <svg className={style.icon}>
                                    <use href="/public/sprite.svg#icon-car" />
                                </svg>
                                Type: {car.type}
                            </p>
                            <p>
                                <svg className={style.icon}>
                                    <use href="/public/sprite.svg#icon-fuel-pump" />
                                </svg>
                                Fuel Consumption: {car.fuelConsumption}
                            </p>
                            <p>
                                <svg className={style.icon}>
                                    <use href="/public/sprite.svg#icon-gear" />
                                </svg>
